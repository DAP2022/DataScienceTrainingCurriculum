...
## Question 1:
Using the Great Apes Dataframe that you built in Module 1, do the following:
...
- With slicing and Boolean Logic: Only include males that are smaller than 120 lbs or shorter than 140 cm
...
- Use the subset function to reproduce the above answer to "Only include males that are smaller than 120 lbs or shorter than 140 cm"
- Now that you have added a column to the Great Apes dataframe, save it (under a different name) to your RAssignments folder as a .csv file. 
