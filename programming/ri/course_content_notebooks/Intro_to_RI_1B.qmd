...
-   excellent strategy for learning to code

**P** - Predict the code

**R** - Run the code

**I** - Interpret the code

**M** - Modify the code

**M** - Make the code 'from scratch'.
...
# and going to the last element of the first column and then snaking back up to the first smoking_exercise<-c(7,9,12,87,4,8,9,102)
