...
To learn best practices for writing clear, maintainable, and collaborative code, we also recommend our Code Readability and Reproducibility course: [Code Craft](./programming/Workshop_Coding_for_Collaboration/README.md). Good code is not only correct—it should also be understandable and reusable by your future self and by others.
